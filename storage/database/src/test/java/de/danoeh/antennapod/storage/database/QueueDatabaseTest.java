...
public class QueueDatabaseTest {
    ...
    public void testRemoveItemsFromMultipleQueues() throws Exception {
        ...
        List<FeedItem> queueB = DBReader.df_getQueuedFeedItems(queueBId);
    ...
    public void testClearQueue() throws Exception {
        ...
        assertEquals(0, DBReader.df_getQueuedFeedItems(DEFAULT_QUEUE_ID).size());
    }
    ...
    public void testRemoveQueue() throws Exception {
        ...
        assertEquals(1, DBReader.df_getQueuedFeedItems(queueToDeleteId).size());
